...
{
	//ancienne version exportait le oméga phi kappa (utilisations ????)
...
//Calcul Axe et angle à partir de R
//------------------------------------------------------------------------
...
//Calcul R à partir de Axe et angle  
//------------------------------------------------------------------------
...
//------------------------------------------------------------------------
void XMat3D::BinaryWrite(std::ofstream& out){
    A.BinaryWrite(out);
    B.BinaryWrite(out);
    C.BinaryWrite(out);
}
